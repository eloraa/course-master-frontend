...
export const ThemeSelector = ({ className }: { className?: string }) => {
  ...
  return (
    <TooltipProvider>
      <div className={cn('flex items-center gap-0.5 p-0.5 rounded-full bg-accent dark:bg-muted/30 relative', className)}>
        {!initialized && (
          <div className="absolute z-10 rounded-full size-full inset-0 bg-popover/95 p-0.5 flex items-center">
