...
import { Navigator } from '@/components/admin-dashboard/header/navigator';
import { ThemeToggler } from '@/components/admin-dashboard/header/theme-toggler';
...
export const Header = ({ initialSession }: { initialSession: Session | null }) => {
  ...
  const navigation: NavigationItem[] = [
    ...
    ...(initialSession?.role === 'admin' ? [{ name: 'Admin Dashboard', href: '/admin/dashboard' }] : []),
  ];
