  ...
  return (
    <label htmlFor="theme-toggle" data-version="v1">
      <div className="relative flex items-center">
        ...
        <select onChange={e => toggleTheme(e.target.value as Theme)} aria-invalid="false" value={theme} className="px-6 pl-7 h-6 text-xs appearance-none" aria-label="Change color theme">
